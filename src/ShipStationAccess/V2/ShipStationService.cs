...
namespace ShipStationAccess.V2
{
	public sealed class ShipStationService: IShipStationService
	{
		...
		public void UpdateWeight( string orderId, decimal weight, string weightUnit )
		{
			var orderToUpdate = this.GetOrderById( orderId );
			orderToUpdate.Weight = new ShipStationItemWeight( weight, weightUnit );
